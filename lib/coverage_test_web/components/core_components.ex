defmodule CoverageTestWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(CoverageTestWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(CoverageTestWeb.Gettext, "errors", msg, opts)
    end
  end
